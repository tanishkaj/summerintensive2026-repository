---
title: "Growth curve analysis using the Tecan 96-well plate reader - Knockout Strains
  May 29 2026"
...
* A sample sheet, with the _four_ required columns: __Well__, __Sample__,	__Bio_rep__,	__Tech_rep__
  + The Well column did not have 0s in the well names (i.e. A1, not A01)
  + An additional column - __Species__ - after Tech_rep which will be output as well metadata with the growth curve information 9an abritrary number of columns can be added)
...
filepath = 'C:/Users/tanis/Gresham Lab/summerIntensive2026/data/'
# sample sheet file name
s_sheet = 'samplesheet.csv.csv'
# data csv
data_file = 'ODdata.csv.csv'
